...
import static com.example.thinkopedia.R.layout.activity_b_q4;

public class BirdA4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(activity_b_q4);
        ...
        Button bOwl = (Button) findViewById(R.id.owl);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(BirdA4.this, MainActivity.class));
        finish(); }
