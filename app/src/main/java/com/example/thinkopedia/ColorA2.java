...
import static com.example.thinkopedia.R.layout.activity_c2;

public class ColorA2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(activity_c2);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ColorA2.this, MainActivity.class));
        finish(); }
