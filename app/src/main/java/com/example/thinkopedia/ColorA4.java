...
import static com.example.thinkopedia.R.layout.activity_c4;

public class ColorA4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(activity_c4);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ColorA4.this, MainActivity.class));
        finish(); }
