...
import static com.example.thinkopedia.R.layout.activity_c5;

public class ColorA5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(activity_c5);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ColorA5.this, MainActivity.class));
        finish(); }
