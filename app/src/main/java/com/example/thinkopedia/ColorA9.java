...
import static com.example.thinkopedia.R.layout.activity_c9;

public class ColorA9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(activity_c9);
        ...
        Button bPink = (Button) findViewById(R.id.pink);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ColorA9.this, MainActivity.class));
        finish(); }
